          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+916360233799" className="block text-gray-700 hover:text-gray-900">+91 6360233799</a>
                  <a href="tel:+919880046990" className="block text-gray-500 text-sm hover:text-gray-700">+91 9880046990</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-slate-50 border border-gray-200 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <a href="mailto:ismartfinserv@gmail.com" className="block text-gray-700 hover:text-gray-900">ismartfinserv@gmail.com</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-slate-50 border border-gray-200 rounded-xl flex items-center justify-center flex-shrink-0">
